...
Example test_total_relation_1:
  total_relation(le).
Proof. 
  apply total_relation_ind with le.
  intros a b . Admitted.

Inductive total_relation' (Rel: nat -> nat -> Prop)(a b: nat):Prop :=
  total':  Rel a b \/ Rel b a -> total_relation' Rel a b.
Example test_total_relation'_1:
...
~R 2 2 6.
Proof.
  unfold not. intros. inversion H. inversion H3. inversion H7. inversion H11.
  inversion H15. inversion H16. inversion H23. inversion H27. Admitted.
(* c5があるとnotの証明のinversionが止まらない？！*)
